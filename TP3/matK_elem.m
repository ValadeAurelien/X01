function [Kel] = matK_elem(S1, S2, S3, Acst, alpha, epsilon)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mat_elem :
...
if (Acst==0)
    ...
    % Integrale de A
    Aq = w1  * A(X1(1), X1(2), Acst, alpha, epsilon) + ...
         w234*(A(X2(1), X2(2), Acst, alpha, epsilon) + ...
               A(X3(1), X3(2), Acst, alpha, epsilon) + ...
               A(X4(1), X4(2), Acst, alpha, epsilon));
    norm_ref = zeros(3, 2);
    norm_ref(1, :) = [-1, -1];
    norm_ref(2, :) = [1, 0];
    norm_ref(3, :) = [0, 1];
